...
RESPONSE_TIME_BY_INDEXER = Gauge("prowlarr_response_time_by_indexer_milliseconds", "Response time for each indexer in Milliseconds", ["alias", "indexer"])
RESPONSE_TIME_BY_INDEXER_T = Gauge("prowlarr_response_time_by_indexer_milliseconds_total", "Total response time for each indexer in Milliseconds", ["alias"])
GRAB_RESPONSE_TIME_BY_INDEXER = Gauge("prowlarr_grab_response_time_by_indexer_milliseconds", "Grab response time for each indexer in Milliseconds", ["alias", "indexer"])
GRAB_RESPONSE_TIME_BY_INDEXER_T = Gauge("prowlarr_grab_response_time_by_indexer_milliseconds_total", "Total grab response time for each indexer in Milliseconds", ["alias"])
